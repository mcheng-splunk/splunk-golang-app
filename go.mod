...
require (
	...
	github.com/signalfx/splunk-otel-go/distro v1.17.0 // indirect
	github.com/signalfx/splunk-otel-go/instrumentation/github.com/go-chi/chi/splunkchi v1.17.0 // indirect
